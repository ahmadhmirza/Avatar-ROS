...
class image_feature:
    ...
    def __init__(self):
        ...
        # subscribed Topic
        self.subscriber = rospy.Subscriber("android_test/Publisher_Android",
            CompressedImage, self.callback,  queue_size = 1)
        if VERBOSE :
            print ("subscribed to android_test/Publisher_Android")
...
def main(args):
    ...
    ic = image_feature()
    rospy.init_node('Avatar_Desktop', anonymous=True)
    try:
        rospy.spin()
