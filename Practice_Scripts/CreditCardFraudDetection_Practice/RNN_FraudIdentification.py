...
csv_filePath = r"/home/ahmad/catkinJava_ws/LSTM/CreditCardFraudDetection_Practice/Data/creditcard.csv"
data = pd.read_csv(csv_filePath, skiprows=[0], header=None)
